...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 24, 2026 at 09:59 AM
...
CREATE TABLE `orders` (
  ...
  `order_status` enum('Pending','Confirmed','Baking','Ready for Pickup','Out for Delivery','Completed','Cancelled') DEFAULT 'Pending',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `order_item_customizations` (
  `customization_record_id` int(11) NOT NULL,
  `order_item_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `order_item_customizations`
  ADD PRIMARY KEY (`customization_record_id`),
...
--
ALTER TABLE `order_item_customizations`
  MODIFY `customization_record_id` int(11) NOT NULL AUTO_INCREMENT;
